 ...
 */
package com.bcom.pocnetconfschemaless.cli.commands;
...
public class PocnetconfschemalessCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(PocnetconfschemalessCliTestCommand.class);
    protected final PocnetconfschemalessCliCommands service;

    public PocnetconfschemalessCliTestCommand(final PocnetconfschemalessCliCommands service) {
